...
<link href="app\Views\css\signin.css" rel="stylesheet">
  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        <a class="navbar-brand" href="/index-users">CERTIFICO</a>
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdown01">
                      <a class="dropdown-item" href="participante_users">Participante</a>
                      <hr class="divider">
                      <a class="dropdown-item" href="inscricao_users">Inscrição</a>
                  </div>
              </li>
              ...
              <li class="nav-item active dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdown01">
                      <a class="dropdown-item" href="emitir_cert_users">Emitir Certificados</a>
                      <a class="dropdown-item" href="verificar_cert_users">Validar Certificado</a>
                  </div>
              </li>
